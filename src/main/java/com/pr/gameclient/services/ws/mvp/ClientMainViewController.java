...
import com.pr.gameclient.services.ws.common.UserInfo;
import com.pr.gameclient.services.ws.common.msginteraction.message.RollTheDice;
...
//        data.addAll(userInfoCollection.stream().map(TableRatingRow::new).collect(Collectors.toList()));
    ...
    public static class TableRatingRow {
        ...
        public TableRatingRow(String userInfo) {
